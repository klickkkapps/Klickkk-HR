        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-amber-700 text-sm">
              ...
              <Link href="/billing" className="underline font-medium">Buy extra slots</Link>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-red-700 text-sm">
              ...
              <Link href="/billing" className="underline font-medium">Purchase additional slots</Link> to continue.
            </div>
          </div>
        </div>
      )}
        ...
        <div className="divide-y divide-border">
          {recentEmployees.length === 0 ? (
            <div className="p-8 text-center text-slate-400">
              ...
              <p className="text-sm">No employees yet. <Link href="/employees/new" className="text-blue-600 hover:underline">Add your first employee</Link></p>
            </div>
          ) : (
